...
docker pull 277707129180.dkr.ecr.us-east-1.amazonaws.com/yt-chrome-plugin:latest
...
docker run -d -p 80:5000 --name campusx-app 277707129180.dkr.ecr.us-east-1.amazonaws.com/yt-chrome-plugin:latest
